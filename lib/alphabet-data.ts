...
const ARMENIAN_LETTERS: LetterData[] = [
  ...
  { letter: "Ե", letterLower: "ե", name: "Yech", sound: "ye", exampleWord: "երկիր", exampleWordEn: "sky", emoji: "☁️" },
  ...
  { letter: "Ր", letterLower: "ր", name: "Reh", sound: "r", exampleWord: "րանգ", exampleWordEn: "rain", emoji: "🌧️" },
